...
class Cart:
    ...
    def print_check(self):
        ...
        for product in sorted(self.goods, key=lambda product: product.name):
            print(f'{product.name} {product.price} {self.goods[product]} {self.goods[product] * product.price}')
